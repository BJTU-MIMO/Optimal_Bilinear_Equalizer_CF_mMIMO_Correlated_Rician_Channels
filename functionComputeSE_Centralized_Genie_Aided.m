function [SE_Centralized] = functionComputeSE_Centralized_Genie_Aided(Hhat,V_Combining,tau_c,tau_p,nbrOfRealizations,M,N,K,p)
%%=============================================================
%The file is used to compute the achievable SE for the centralized processing by Monte-Carlo methods based on
%the genie aided capacity bound of the paper:
%
...
for n = 1:nbrOfRealizations
    ...
    for k = 1:K
        ...
        denominator = norm(v'*Hhatallj*Dp12)^2 + v'*eyeMN*v - numerator;
