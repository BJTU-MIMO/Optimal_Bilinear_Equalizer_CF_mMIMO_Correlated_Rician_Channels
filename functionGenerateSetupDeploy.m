function [R_AP,HMean_Withoutphase,channelGain,channelGain_LoS,channelGain_NLoS] = functionGenerateSetupDeploy(M,K,N,nbrOfSetups,correlatedShadowing)
%%=============================================================
%The file is used to generate the system setup of the paper:
%
